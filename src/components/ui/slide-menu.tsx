      ...
      >
        <div className="p-8 h-full flex flex-col overflow-y-auto">
          ...
          <div className="flex justify-between items-center mb-8 flex-shrink-0">
            ...
            <button
              onClick={onClose}
              className="w-9 h-9 flex items-center justify-center rounded-full hover:bg-gray-100/80 transition-all duration-200 flex-shrink-0"
            >
          ...
          <div className="flex-1 overflow-y-auto">
            ...
            <div className="mb-6">
              <div className="bg-gray-50/80 rounded-xl p-4">
                ...
                <Link 
                  href="/funding" 
                  className="group flex items-center px-4 py-3 text-gray-900 hover:bg-white/60 rounded-lg transition-all duration-200"
                  onClick={onClose}
                >
